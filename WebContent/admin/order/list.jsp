		...
		<script type="text/javascript">
			$(function(){
				...
				new PopupLayer({
					...
					closeBtn:"#closeBtn",//关闭按钮                         这几个都是使用选择器
					useOverlay:true
				});
			...
			function findOrderInfoByOid(oid){
				...
				$.post(
				    ...
				    function(data){
				    	...
				    	//   {"shop_price":6688.0,"count":3,"pname":"Apple MacBook Air MJVE2CH/A 13.3英寸","pimage":"products/1/c_0032.jpg","subtotal":20064.0}
				    	//]
                        var content="<tr id='showTableTitle'><th width='20%'>图片</th><th width='25%'>商品</th><th width='20%'>价格</th><th width='15%'>数量</th><th width='20%'>小计</th>";
