			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath }/user?method=register" method="post" style="margin-top: 5px;">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="username" name="username" plceholder="请输入用户名">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							...
							<label class="error" for="sex" generated="true" style="display: none">你没有第三种选择</label>
						</div>
					</div>
					<div class="form-group">
